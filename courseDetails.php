...
<div class="container-fluid">
    <div class="row">
        <img src="image/mainbook.jpg" alt="courses" style="height:500px; width:100%; object-fit:cover; box-shadow:10px;"></div>
</div>
</div>
</div>
        ...
        <div class="col-md-8">
            <div class="card-body">
                ...
                <form action="checkout.php" method="post">
                    ...
                    <input type="hidden" name="id" value="<?php echo $row['course_price'] ?>" readonly>
                    <button type="submit" href="checkout.php" class="btn btn-primary text-white font-weight-bolder float-right" name="buy">Buy Now</button>
                </form>
            </div>
        </div>
    </div>
